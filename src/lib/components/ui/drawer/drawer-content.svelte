...
<DrawerPrimitive.Portal {...portalProps}>
	...
	<DrawerPrimitive.Content
		...
		class={cn(
			"group/drawer-content bg-background fixed z-50 flex h-auto w-[calc(100%)] flex-col gap-3 p-3",
			"border data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:rounded-b-lg data-[vaul-drawer-direction=top]:border-t-0",
	...
	>
		<div
			class="bg-muted mx-auto mt-4 hidden h-1.5 w-24 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
		></div>
		{@render children?.()}
	</DrawerPrimitive.Content>
